...
void voidPlay(void)
{
	switch (u8Data)
	{
		case 70: MGPIO_voidSetPinValue(GPIOA,2,GPIO_HIGH); break;
		case 69: MGPIO_voidSetPinValue(GPIOA,2,GPIO_LOW);  break;
	}
}
...
void main(void)
{
	...
	MGPIO_voidSetPinDirection(GPIOA,2,0b0010); /* A2 Output PP "GREEN"     */
	MGPIO_voidSetPinDirection(GPIOA,3,0b0010); /* A3 Output PP "BLUE"      */
